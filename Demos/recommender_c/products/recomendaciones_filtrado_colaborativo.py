...
def similitud_pearson(id_activo, id_usuario_x, lista_produtos, prom_u, prom_v):
    ...
    for cada_producto in lista_produtos:
        u_i = Calificaciones.objects.get(Q(users_id=id_activo) & Q(product_id=cada_producto))
        u_i = u_i.calificacion_producto
        v_i = Calificaciones.objects.get(Q(users_id=id_usuario_x) & Q(product_id=cada_producto))
