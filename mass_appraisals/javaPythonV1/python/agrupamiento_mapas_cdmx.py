...
cluster_path = "/Users/sam/Github/Recommender-platform/mass_appraisals/javaPythonV1/python/"
...
def get_clusters(appraisals_dicts, num_clusters, iterations, homologation):
	...
	return asignation_mat, clusters
...
# Generacion de archivos arff y mapas
...
# cada cluster se recalcula como el promedio de los puntos de prueba asociados
def create_clusters_arff_maps(appraisals_dicts, asignation_mat, num_clusters, clusters, file_name_base):
	inmuebles_asociados = [[]]*num_clusters
	...
	file_name_cluster_files_txt = "cluster_files_" + file_name_base + ".txt"
	f_cluster_files = open(file_name_cluster_files_txt, 'w')
	
	for c in range(num_clusters):
		if len(inmuebles_asociados[c]) > 4:
			icon_marker = pin_icons.next()
			file_name = file_name_base + "_" + str(c+1) + "_de_" + str(num_clusters)
			print "FILE NAME: ", file_name
			f_cluster_files.write(cluster_path+file_name + '.arff\n')
...
"""
	map_file_name = "map_"+file_name_base
...
filters_set = [
				#{"CLAVE_ENTIDAD_FEDERATIVA_UBICACION_INMUEBLE": ['09'],"CAT_TIPO_INMUEBLE":['4'], "CVE_USO_CONSTRUCCION":['1'], "CVE_CLASE_INMUEBLE":['4'], "CVE_NIVEL_SOCIO_ECONOMICO_ZONA":['4'], "CVE_CLASIFICACION_ZONA": [ '3', '4'], "GRADO_TERMINACION_OBRA": ['100', '100.0', '100.00']},
				#{"CLAVE_ENTIDAD_FEDERATIVA_UBICACION_INMUEBLE": ['09'],"CAT_TIPO_INMUEBLE":['4'], "CVE_USO_CONSTRUCCION":['1'], "CVE_CLASE_INMUEBLE":['5'], "CVE_NIVEL_SOCIO_ECONOMICO_ZONA":['5'], "CVE_CLASIFICACION_ZONA": [ '3', '2'], "GRADO_TERMINACION_OBRA": ['100', '100.0', '100.00']},
				#{"CLAVE_ENTIDAD_FEDERATIVA_UBICACION_INMUEBLE": ['09'],"CAT_TIPO_INMUEBLE":['4'], "CVE_USO_CONSTRUCCION":['1'], "CVE_CLASE_INMUEBLE":['6', '7'], "CVE_NIVEL_SOCIO_ECONOMICO_ZONA":['6'], "CVE_CLASIFICACION_ZONA": [ '2', '1'], "GRADO_TERMINACION_OBRA": ['100', '100.0', '100.00']},
				#{"CLAVE_ENTIDAD_FEDERATIVA_UBICACION_INMUEBLE": ['09'],"CAT_TIPO_INMUEBLE":['2', '3'], "CVE_USO_CONSTRUCCION":['1'], "CVE_CLASE_INMUEBLE":['4'], "CVE_NIVEL_SOCIO_ECONOMICO_ZONA":['4'], "CVE_CLASIFICACION_ZONA": [ '3', '4'], "GRADO_TERMINACION_OBRA": ['100', '100.0', '100.00']},
				{"CLAVE_ENTIDAD_FEDERATIVA_UBICACION_INMUEBLE": ['09'],"CAT_TIPO_INMUEBLE":['2', '3'], "CVE_USO_CONSTRUCCION":['1'], "CVE_CLASE_INMUEBLE":['5'], "CVE_NIVEL_SOCIO_ECONOMICO_ZONA":['5'], "CVE_CLASIFICACION_ZONA": [ '3', '2'], "GRADO_TERMINACION_OBRA": ['100', '100.0', '100.00']},
				{"CLAVE_ENTIDAD_FEDERATIVA_UBICACION_INMUEBLE": ['09'],"CAT_TIPO_INMUEBLE":['2', '3'], "CVE_USO_CONSTRUCCION":['1'], "CVE_CLASE_INMUEBLE":['6', '7'], "CVE_NIVEL_SOCIO_ECONOMICO_ZONA":['6'], "CVE_CLASIFICACION_ZONA": [ '2', '1'], "GRADO_TERMINACION_OBRA": ['100', '100.0', '100.00']},
				]


entidad_dict = {"01": "aguascalientes", 
				"02": "baja_california", 
...
for filters in filters_set:
	...
	if num_appraisals > 0:
		...
		file_name_base = "inmuebles_" + inmuebles_dict[filters["CAT_TIPO_INMUEBLE"][0]] + "_nivel_"+clases_dict[filters["CVE_CLASE_INMUEBLE"][0]] + "_entidad_" + entidad_dict[filters["CLAVE_ENTIDAD_FEDERATIVA_UBICACION_INMUEBLE"][0]]  
		print "file_name_base: ", file_name_base

		num_clusters = num_appraisals/15
		num_clustering_iter = 200
		not_euclidian = False



		asignation_mat, clusters = get_clusters(appraisals, num_clusters, num_clustering_iter, not_euclidian)
		create_clusters_arff_maps(appraisals, asignation_mat, num_clusters, clusters, file_name_base)
