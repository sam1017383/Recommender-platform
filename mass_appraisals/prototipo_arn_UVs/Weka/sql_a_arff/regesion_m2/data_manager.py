...
def normalise(each_appraisal):
	...
	each_appraisal["CVE_DENSIDAD_POBLACION"] = float(each_appraisal["CVE_DENSIDAD_POBLACION"])/7
	...
	# dimensiones comunes
	each_appraisal["IMPORTE_ENFOQUE_INGRESOS"] = float(each_appraisal["IMPORTE_ENFOQUE_INGRESOS"])
	each_appraisal["IM_RENTAS_RENTAUNITARIA_M2"] = float(each_appraisal["IM_RENTAS_RENTAUNITARIA_M2"])
